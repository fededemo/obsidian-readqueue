...
**Los documentos de QA viajan con el cambio que validan.** Un PR que solo actualiza el bloque "QA status" del ROADMAP es de 10 líneas y se queda 50 días abierto — ya pasó cuatro veces en saccum. Si estás validando un PR, tu bloque de QA va en ese PR; si validás algo ya mergeado, agrupá varias validaciones en un solo PR de documentación.
