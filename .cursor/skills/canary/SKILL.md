---
name: canary
description: "Post-deploy monitoring: errors, performance, screenshots vs baseline. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
After a deploy, check health endpoints, recent errors, and a screenshot of the happy path if possible.
