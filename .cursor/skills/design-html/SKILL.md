---
name: design-html
description: "Turn an approved mockup into HTML that reflows. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Semantic HTML, real text, no fixed heights that clip. Match the project's design tokens.
