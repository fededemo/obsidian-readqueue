---
name: freeze
description: "Restrict edits to a directory. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Only edit files under the frozen path. Anything else is out of scope.
