---
name: guard
description: "Maximum safety: careful + freeze the working tree to a directory. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Apply `careful`. Restrict edits to the directory the user named. Do not expand scope.
