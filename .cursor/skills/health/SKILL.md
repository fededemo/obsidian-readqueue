---
name: health
description: "Code quality score: types, lint, tests, dead code. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Run the project's typecheck, lint, and tests. Summarize failures. Do not boil the ocean of warnings.
