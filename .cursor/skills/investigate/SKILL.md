---
name: investigate
description: "Systematic debugging. No fix without root cause. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Reproduce, isolate, name the root cause with file:line, then fix if asked. Do not shotgun-patch symptoms.
