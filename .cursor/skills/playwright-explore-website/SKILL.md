...
description: "Explore a site with Playwright. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Write or run Playwright against the target. Return a structured map: nav, forms, risks.
