---
name: qa-only
description: "QA report only — do not fix. Use in Cursor/Grok; this is the portable wrapper, not the Claude gstack binary."
---
...
Same discovery as `qa`, but do not edit product code. Write a report of bugs with repro steps.
