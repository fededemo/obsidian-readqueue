...
| B-733 | Reintentar las **29 notas** que fallaron el etiquetado (12%) y ajustar el prompt del vocabulario para que no genere conceptos-paraguas (6 descartados por >20 fuentes) | TODO | builder | B-724c | Cobertura >70%; ningún cluster con más de ~20 fuentes |
| B-734 | Escribir 6-8 notas-concepto desde el canon, con citas. Mejores candidatos: *Compounding de capital humano y tecnológico* (17), *Manipulación institucional de la verdad* (13), *Captura de valor desigual* (13), *Sobrecapacidad e incompetencia a escala* (13) | TODO | builder + vault-gardener | B-724c | Notas en `Concepts/` con wikilinks verificados |
